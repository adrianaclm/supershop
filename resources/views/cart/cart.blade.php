        ...
        <div class="row justify-content-center">
                ...
                @foreach($cartCollection as $item)
                    <div class="row">
                        <div class="col-4 col-lg-3">
                            <img src="{{ asset('img/producto/' . $item->attributes->image)  }}" class="img-thumbnail" width="100" height="100">
                        </div>
                                ...
                                <form action="{{ route('cart.update') }}" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="number" class="form-control form-control-sm" value="{{ $item->quantity }}"
                                               id="quantitys" name="quantity" style="width: 50px; margin-right: 2px;">
                                        <button class="btn btn-success btn-sm" style="width: 50px; margin-right: 2px;"><i class="fa fa-edit"></i></button>
                                    </div>
                                </form>
            ...
            @if(count($cartCollection)>0)
                <div class="col-10 col-lg-5 mt-5">
                    ...
                    <form method="POST" action="{{ route('card.procesar') }}">
                        @csrf
                        ...
                        <br>
                        <input type="submit" value="Procesar Pedido" class="btn btn-outline-danger mb-2">
