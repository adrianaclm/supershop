    ...
    <div class="container-fluid">
                ...
                <div class="carousel-inner">
                    @foreach ($imgs as $key => $img)
                        <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                            @if ($img->image)
                                <img src={!! asset('img/carrusel/' . $img->image) !!} class="d-block w-100" alt="..." />
                            @endif
                        </div>
                ...
                @foreach ($categorias as $c)
                    <div class="col-6 col-sm-4 col-md-4 col-xl-3 mb-3 articulo">
                        <div class="card border-2 rounded-4">
                            ...
                            <div class="text-center rounded-3 border-top border-danger border-5 p-2 "
                ...
                @foreach ($productos as $r)
                    <div class="col-6 col-sm-4 col-md-4 col-xl-3 mb-1 articulo">
                        <div class="card border-2 rounded-4" style="margin-bottom: 20px; height: auto;">
                            <img src={!! asset('img/producto/' . $r->image) !!} class="card-img-top mx-auto my-2 p-2 rounded rounded-4"
        ...
        <div class="row border border-danger border-5 rounded m-0">
            ...
            <div class="col-12 col-md-4 col-lg-3 mt-1 text-start">
                ...
                <a class="nav-link m-1 icns" href="https://www.facebook.com/Supershopep-103133128804417/"
                    target="_blank"><i class="fa-brands fa-facebook"></i> Supershopep</a>
                <a class="nav-link m-1 icns" href="https://instagram.com/supershopep_oficial?igshid=YmMyMTA2M2Y="
                    target="_blank"><i class="fa-brands fa-instagram"></i> @supershopep_oficial</a>
            ...
            <div class="col-12 col-md-3 col-lg-3 mb-0 mt-1 text-center">
                ...
                <div class="nav-link">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1166.3098124433482!2d-66.90728620919562!3d10.502007865226918!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8c2a5ed4810022b1%3A0x95a96d1d31e61790!2sCentro%20Parque%20Carabobo%2C%20Avenida%20Universidad%2C%20Caracas%201011%2C%20Distrito%20Capital!5e0!3m2!1ses!2sve!4v1663453031798!5m2!1ses!2sve"
                        class="border border-dark border-1" width="auto" height="150" allowfullscreen=""
